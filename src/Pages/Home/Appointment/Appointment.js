        ...
        <div className='container'>
            ...
            <form className="row g-3 container">
                <div className="col-md-6">
                    <label for="inputCondition" className="form-label">First Name</label>
                ...
                <div className="col-12">
                    <label for="inputAge" className="form-label">Your Age</label>
                    <input type="number" className="form-control" id="inputAddress2" placeholder="age please" />
                </div>
                <div className="col-md-6">
                    <label for="inputCity" className="form-label">Select A Day</label>
